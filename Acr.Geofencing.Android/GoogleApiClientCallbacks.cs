...
namespace Acr.Geofencing
{
    ...
    public class GoogleApiClientCallbacks : Java.Lang.Object, GoogleApiClient.IConnectionCallbacks, GoogleApiClient.IOnConnectionFailedListener, IResultCallback
    {
